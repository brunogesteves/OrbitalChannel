<div class="flex justify-between  items-start w-full h-auto m-auto">
        ...
        <div class="w-1/2 h-[500px] relative bg-black">
            ...
            <div class="slideAd h-[150px] mt-2 ">
                <div class="carousel-container-adSlide h-full">
                    <div class="carousel-adSlide h-full">
                        <?php foreach ($adsSlide as $ad) : ?>
                            <div class="carousel-slide-adSlide h-full relative ">
                                <a href="/<?= $ad["link"] ?>">                                
            ...
            <?php foreach ($posts3 as $post) : ?>
                <div class="flex w-full my-5">
                    <a href=/<?= $post["slug"] ?>>
                        ...
                        <p class="text-2xl font-bold break-words text-left pl-2">
                            <?= $post["title"] ?>
                        </span>
                    </a>
                </div>
