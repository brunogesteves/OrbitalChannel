...
?>
<div class="flex max-[767px]:flex-col pt-5">
    <div class="w-1/6 max-[767px]:w-full flex justify-center"></div>
            ...
            <div id="shortArticle">
                ...
                <div class="mt-3">
                    <span id="text" class="text-justify mt-3 mb-7 max-sm:px-2 mt-3">
                        ...
                        <?= $content["source"] === "Orbital Channel"? $content["content"]: substr($content["content"], 0, 250); ?>...
                    </span>
                </div>
                <div class="flex flex-col w-full  max-sm:justify-center mb-3  items-center">
                    ...
                    <button class="bg-black text-white p-3 w-52 rounded-md" id="shortArticleBtn">
                        Ler matéria completa
                    </button>
                </div>
            </div>
            <div class="w-full h-full p-3" id="completeArticle">
    ...
    <div class="w-1/6 max-[767px]:w-full flex flex-col justify-start  gap-y-5 text-center">
        <span class="font-bold text-xl">Mais Posts</span>
        <?php foreach ($morePosts as $morePost): ?>
            <div>
                <a href="/<?= $morePost["slug"] ?>">
                    <img src="images/<?= $morePost["image"] ?>" class="max-[767px]:w-full h-full" />
                </a>
                <p class=" text-xl font-bold mt-1"><?= $morePost["title"] ?></p>
            </div>
        <?php endforeach ?>
